...
<form name="baca" method="post" class="form-horizontal">
	<input type="hidden" name="id" value="<?php echo $data['id_pesan']; ?>">
		...
		<div class="form-group">
			...
			<div class="col-md-4"> <input type="text" class="form-control" name="subjek" size="50" value="<?php echo $data['subjek']; ?>"></div> 
		</div>
